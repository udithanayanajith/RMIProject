...
public interface Taxi_Remote_Interface extends Remote  {
	...
	public void addAnswer(int q1_1,int q1_2,int q1_3,int q2_1,int q2_2,int q2_3,int q3_1,int q3_2,int q3_3,
			int q4_1,int q4_2,int q4_3,int q5_1,int q5_2,int q5_3,int q6_1,int q6_2,int q6_3) throws RemoteException;
